# DevCrew: technical guide

The detailed reference behind the [README](../README.md): architecture, every subsystem and
...
- [Existing repositories and quality gates (Phase 11)](#existing-repositories-and-quality-gates-phase-11)
- [Workflow view and requirements documents (Phase 10)](#workflow-view-and-requirements-documents-phase-10)
- [Benchmark (Phase 9)](#benchmark-phase-9)
- [GitHub delivery (Phase 8)](#github-delivery-phase-8)
- [Web UI (Phase 7)](#web-ui-phase-7)
- [HTTP API (Phase 6)](#http-api-phase-6)
- [Parallel execution, Coordinator and agent Q&A (Phase 5)](#parallel-execution-coordinator-and-agent-qa-phase-5)
- [Sandbox (Phase 3)](#sandbox-phase-3)
- [Code retrieval / RAG (Phase 4)](#code-retrieval--rag-phase-4)
- [Prerequisites](#prerequisites) · [Run](#run) · [Backend development](#backend-development-on-the-host) · [Run from the terminal](#run-from-the-terminal-phase-2) · [Configuration](#configuration)
