...
Moved verbatim from codemind/prompts.py as part of unifying CodeMind's
per-file LLM extraction into the ChromaDB ingestion pipeline (see plan file
section I) -- this prompt's wording (demanding genuine conditional business
logic, not mechanism description) was deliberately tuned earlier and must
